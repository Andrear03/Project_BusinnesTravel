$(document).ready(function () {
  ...
  if (localStorage.getItem('resultado-mensajes')==''){
  localStorage.setItem('resultado-mensajes',null)
  }
   
  var savedMessages = JSON.parse(localStorage.getItem('resultado-mensajes')) || [];
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        if (response.content) {
          ...
          localStorage.setItem('resultado-mensajes', JSON.stringify(savedMessages));
        ...
        $('#ButtonDownload').removeClass('hidden')
      },
